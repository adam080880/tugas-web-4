<?php
    // get connection from db.php, and write function insert_review to insert to database and get post data name, email, and comment
    require_once './db.php';

    function insert_review($name, $email, $comment) {
        global $conn;

        $query = "INSERT INTO reviews (name, email, comment) VALUES (?, ?, ?)";
        $stmt = mysqli_prepare($conn, $query);
        mysqli_stmt_bind_param($stmt, "sss", $name, $email, $comment);
        mysqli_stmt_execute($stmt);
    }

    // if form submitted post exist, get name, email, comment, and pass to the function above
    if (isset($_POST['submit'])) {
        $name = $_POST['name'];
        $email = $_POST['email'];
        $comment = $_POST['comment'];
        insert_review($name, $email, $comment);
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="navbar-toggler-success">
                <div class="flex-fill mx-xl-5 mb-2">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-xl-5 text-center text-dark">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn-outline-primary rounded-pill px-3" href="review.php">Beri Review</a>
                        </li>
                    </ul>
                </div>
                ...
                <form class="contact-form row" method="post" role="form">
                    ...
                    <div class="col-12">
                        <div class="form-floating mb-3">
                            <textarea name='comment' class="form-control light-300" rows="8" placeholder="Message" id="floatingtextarea"></textarea>
                            <label for="floatingtextarea light-300">Message</label>
                        </div>
                    </div><!-- End Textarea Message -->

                    <div class="col-md-12 col-12 m-auto text-end">
                        <button name='submit' type="submit" class="btn btn-secondary rounded-pill px-md-5 px-4 py-2 radius-0 text-light light-300">Beri Review</button>
                    </div>
                ...
                <div class="col-lg-3 col-md-4 my-sm-0 mt-4">
                    <h3 class="h4 pb-lg-3 text-light light-300">Our Company</h2>
                        <ul class="list-unstyled text-light light-300">
                            ...
                            <li class="pb-2">
                                <i class='bx-fw bx bxs-chevron-right bx-xs'></i><a class="text-decoration-none text-light py-1" href="review.php">Beri Review</a>
                            </li>
                        </ul>
                </div>
