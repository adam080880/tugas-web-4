<?php
    ...
    // buat function get_reviews di mana di dalamnya, menarik data dari table reviews lalu panggil function itu dan masukkan ke variable $reviews
    ...
    <section class="py-5 mb-5">
        <div class="container">
            <div class="recent-work-header row text-center pb-5">
                <h2 class="col-md-6 m-auto h2 semi-bold-600 py-5">Reviews</h2>
            </div>
                    ...
                    <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
                        ...
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                                <h3 class="card-title light-300"><?php echo $review['name'] ?></h3>
